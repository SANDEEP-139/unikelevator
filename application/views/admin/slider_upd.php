        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                     <form method="post" action="<?php echo base_url('Admin/Slider/slider_up?sid='.$sid.'&id='.$data['id']);?>" enctype='multipart/form-data'>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Slider</label>
                            <div class="col-sm-4">
                                <input type="file" name="image" class="form-control">
                                <img src="<?= base_url('images/'.$data['image']);?>" height="50px" width="50px">
                            </div>
