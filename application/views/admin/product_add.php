        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                     <form method="post" action="<?php echo base_url('Admin/Product/save'); ?>" enctype='multipart/form-data'>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="headig">
                            </div>
                        </div>
                         <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Description</label>
                            <div class="col-sm-8">
                               <textarea name="desc" class="form-control jqte-test"></textarea>
                            </div>
                        </div>
                         <div class="form-group row">
