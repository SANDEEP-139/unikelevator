...
<!-- classie js -->
<script type="text/javascript" src="<?= base_url('allfiles/admin/bower_components/classie/js/classie.js');?>"></script>
...
<!-- Select 2 js -->
<script type="text/javascript" src="<?= base_url('allfiles/admin/bower_components/select2/js/select2.full.min.js');?>"></script>
<!-- Multiselect js -->
<script type="text/javascript" src="<?= base_url('allfiles/admin/bower_components/bootstrap-multiselect/js/bootstrap-multiselect.js');?>">
</script>
<script type="text/javascript" src="<?= base_url('allfiles/admin/bower_components/multiselect/js/jquery.multi-select.js');?>"></script>
<script type="text/javascript" src="<?= base_url('allfiles/admin/assets/js/jquery.quicksearch.js');?>"></script>
<!-- Custom js -->
<script type="text/javascript" src="<?= base_url('allfiles/admin/assets/js/script.js');?>"></script>
<script type="text/javascript" src="<?= base_url('allfiles/admin/assets/pages/advance-elements/select2-custom.js');?>"></script>
<script src="<?= base_url('allfiles/admin/assets/js/pcoded.min.js');?>"></script>
<script src="<?= base_url('allfiles/admin/assets/js/demo-12.js');?>"></script>
<script src="<?= base_url('allfiles/admin/assets/js/jquery.mCustomScrollbar.concat.min.js');?>"></script>
<script src="<?= base_url('allfiles/admin/assets/js/jquery.mousewheel.min.js');?>"></script>
<script> setTimeout(function(){document.getElementById('msg').style.display='none'}, 3000); 
         setTimeout(function(){document.getElementById('validation').style.display='none'}, 3000); 
         setTimeout(function(){document.getElementById('seerror').style.display='none'}, 3000); 
</script>
</body>
