        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                     <form method="post" action="<?php echo base_url('Admin/People_review/peopleupd?id='.$data['id']); ?>" enctype='multipart/form-data'>
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control jqte-test" rows="3" name="description"><?= $data['review'];?></textarea>
                            </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-3 checkbox-fade fade-in-primary">
                                ...
                                <img src="<?= base_url('images/'.$data['image']);?>" height="45px" width="auto">
                                </div>
